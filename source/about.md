...
* 信仰 <text style="color: red;">**共产主义**</text> <text style="color: gold;">**☭**</text>
* 期待与你成为朋友 🤟🏻

## 我的作品 🌌

* **[creta](https://github.com/ch1ny/creta)** : 一款帮您快速搭建基于 `React` 和 `TypeScript` 的 `electron` 应用脚手架工具

## 一点不切实际的小梦想 ⭐

{% meting "565175885" "netease" "song" %}

<div style="background: #ff0000; border-radius: 12px; width: fit-content; padding: 6px 6px 0 6px;">
  <img class="disabled-kira-image" src="https://readme-typing-svg.demolab.com?font=Fira+Code&duration=2700&pause=250&color=ffff00&background=ff0000&multiline=true&repeat=true&width=435&height=310&lines=Il+n'est+pas+de+sauveurs+supr%C3%AAmes;Ni+Dieu%2C+ni+C%C3%A9sar%2C+ni+tribun;Producteurs+sauvons-nous+nous-m%C3%AAmes;D%C3%A9cr%C3%A9tons+le+salut+commun;Pour+que+le+voleur+rende+gorge;Pour+tirer+l'esprit+du+cachot;Soufflons+nous-m%C3%AAmes+notre+forge;Battons+le+fer+quand+il+est+chaud.;C'est+la+lutte+finale;Groupons-nous%2C+et+demain;L'Internationale;Sera+le+genre+humain." />
</div>
